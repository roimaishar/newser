...
class NewsAnalysisPrompts:
    ...
    SYSTEM_PROMPT = (
        ...
        "\n• CRITICAL: ALWAYS translate Arabic content to Hebrew - NEVER return Arabic text in your response"
        "\n• ALL output must be in Hebrew only - no Arabic characters allowed in your JSON response"
        ...
        "\n\nOUTPUT LANGUAGE REQUIREMENT: Your entire response MUST be in Hebrew only. "
        "If you receive Arabic articles, translate them to Hebrew before including in your analysis. "
        "NEVER include Arabic text in your JSON output - only Hebrew is allowed. "
